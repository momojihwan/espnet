...
from espnet2.asr_transducer.espnet_ctc_model import ESPnetASRCTCModel
...
class ASRCTCTask(AbsTask):
    """ASR CTC Task definition."""
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASRCTCModel),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRCTCModel:
        """Required data depending on task mode.
