...
from espnet2.asr_transducer.espnet_wkd_transducer_model import ESPnetASRWKDTransducerModel
from espnet2.asr_transducer.joint_network import JointNetwork
from espnet2.layers.abs_normalize import AbsNormalize
from espnet2.train.abs_espnet_model import AbsESPnetModel
from espnet2.layers.global_mvn import GlobalMVN
from espnet2.layers.utterance_mvn import UtteranceMVN
from espnet2.tasks.abs_wkd_task import AbsTask
from espnet2.text.phoneme_tokenizer import g2p_choices
from espnet2.train.class_choices import ClassChoices
from espnet2.train.collate_fn import CommonCollateFn
from espnet2.train.preprocessor import CommonPreprocessor
from espnet2.train.wkd_trainer import Trainer
...
class ASRTransducerTask(AbsTask):
    ...
    def build_model(
        ...
        # 7. Build model
        model = ESPnetASRWKDTransducerModel(
