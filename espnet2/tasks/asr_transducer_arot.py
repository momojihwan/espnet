...
from espnet2.asr_transducer.espnet_arot_transducer_model import ESPnetASRAROTTransducerModel
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASRAROTTransducerModel),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRAROTTransducerModel:
        """Required data depending on task mode.
        ...
        # 7. Build model
        model = ESPnetASRAROTTransducerModel(
