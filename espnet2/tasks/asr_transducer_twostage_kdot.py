...
from espnet2.asr_transducer.espnet_twostage_kdot_transducer_model import ESPnetASRKDOTTransducerModel
from espnet2.asr_transducer.joint_network import JointNetwork
from espnet2.layers.abs_normalize import AbsNormalize
from espnet2.layers.global_mvn import GlobalMVN
from espnet2.layers.utterance_mvn import UtteranceMVN
from espnet2.tasks.abs_twostage_kdot_task import AbsTask
from espnet2.text.phoneme_tokenizer import g2p_choices
from espnet2.train.class_choices import ClassChoices
from espnet2.train.collate_fn import CommonCollateFn
from espnet2.train.preprocessor import CommonPreprocessor
from espnet2.train.twostage_kdot_trainer import Trainer
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetASRKDOTTransducerModel),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRKDOTTransducerModel:
        """Required data depending on task mode.
        ...
        # 7. Build model
        model = ESPnetASRKDOTTransducerModel(
