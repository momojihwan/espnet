...
from espnet2.asr_transducer.espnet_kdot_transducer_model import ESPnetASRKDOTTransducerModel
...
class ASRTransducerTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=float_or_none,
            default=0.3,
            help="The optimal transport vaule.",
        )
        group.add_argument(
            "--epsilon",
            type=float_or_none,
            default=0.3,
            help="The sinkhorn epsilon vaule.",
        )
        group.add_argument(
            "--max_iter",
            type=int_or_none,
            default=3,
            help="The sinkhorn maximum iteration vaule.",
        )
        group.add_argument(
            "--kd_weight",
            type=float_or_none,
