...
from espnet2.tasks.asr_fine_transducer import ASRTransducerTask
...
class Speech2Text:
    ...
    def __call__(self, speech: Union[torch.Tensor, np.ndarray]) -> List[Hypothesis]:
        ...
        # batch = {"speech": feats, "speech_lengths": feats_length}
        # enc_out, _ = self.asr_model.encoder(**batch)
        enc_out, _ = self.asr_model.encoder(feats, feats_length)
        enc_out = self.asr_model.ctc_lin(enc_out)
