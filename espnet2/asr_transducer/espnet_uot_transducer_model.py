...
class ESPnetASRUOTTransducerModel(AbsESPnetModel):
    ...
    def __init__(
        ...
        self.fc = torch.nn.Linear(encoder.output_size, vocab_size)
    ...
    def forward(
        ...
        **kwargs,
        ...
        joint_out = joint_out + aligned_features

        # Alignment extract
        # for b in range(speech.shape[0]):
        #     if text[b][0] == 2 and text[b][1] == 317 and text[b][2] == 30:
        #         self.extract_alignment(joint_out, joint_out_before, aligned_features, text, t_len, u_len)
    ...
    def extract_alignment(
        ...
        save_path = "/home/user/Workspace/espnet/egs2/librispeech_100/asr1/exp/asr_train_asr_conformer-rnnt-otg_raw_en_bpe2048_sp/origin_alignment.png"
