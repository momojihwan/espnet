...
class ESPnetASRITPTransducerModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        mid_logits = self.interpolate_logits(joint_out, teacher_joint_out, self.inter_weight)
    ...
    def interpolate_logits(
        ...
        Args:
            ...
            inter_weight: interpolation weight value.
        """
        
        return inter_weight * joint_out + (1 - inter_weight) * teacher_joint_out
